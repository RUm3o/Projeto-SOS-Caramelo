        ...
        <q-list padding class="text-grey-8">
          ...
          <div class="q-mt-md">
            <div class="flex flex-center q-gutter-xs">
              <a class="GNL__drawer-footer-link" href="javascript:void(0)" aria-label="Privacy">Politica de Privacidade</a>
              <span> · </span>
              <a class="GNL__drawer-footer-link" href="javascript:void(0)" aria-label="Terms">Termos de Uso</a>
              <span> · </span>
              <a class="GNL__drawer-footer-link" href="javascript:void(0)" aria-label="About">Sobre o SoS</a>
            </div>
          </div>
        </q-list>
      </q-scroll-area>
...
export default {
  ...
  setup () {
    ...
    return {
      ...
      links1: [
        { icon: 'domain', text: 'Pagina Inicial', name: '/' },
        { icon: 'web', text: 'Registrar um Chamado', name: 'NovoChamado' },
